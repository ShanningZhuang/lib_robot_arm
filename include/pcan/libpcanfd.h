...
int pcanfd_add_filters_list(int fd, int count, const struct pcanfd_msg_filter* pf);
...
DWORD LINUX_CAN_WriteFD_Timeout(HANDLE hHandle, TPCANMsgFD* pMsgBuff, int nMicroSeconds);
